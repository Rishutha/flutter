...
class _RegistrationFormState extends State<RegistrationForm> {
  TEcontroller _name = TEcontroller(text: '');
  TEcontroller _email = TEcontroller(text: '');

  TEcontroller _mobile = TEcontroller(text: '');
  TEcontroller _company = TEcontroller(text: '');
  TEcontroller _city = TEcontroller(text: '');
          ...
          child: Container(
            child: ListView(
              children: <Widget>[
                ...
                SizedBox(height: 20),
                Container(
                    decoration: BD(boxShadow: <BoxShadow>[
                      new BoxShadow(
                        color: Colors.white,
                        spreadRadius: 1,
                        offset: new Offset(0.0, 0.0),
